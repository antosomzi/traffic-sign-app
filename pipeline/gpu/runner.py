...
def start_and_run_pipeline_ssh(recording_id):
    ...
    try:
        ...
        docker_cmd = (
                    ...
                    "-steps detection small-sign-filter tracking small-track-filter classification frame-gps-coordinates-extraction localization -p 1 "
                    "> /home/ec2-user/pipeline.log 2>&1"
                )
